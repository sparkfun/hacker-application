...
<html>
<head>
	<title>Property Disclosure Information for the Buyer.</title>
	
	<meta name="Description" content="Property disclosure information for home buyers.">

	<meta name="Keywords" content="Property Disclosure, Home Buyer">
	...
	<tr>
		...
		<td id="right">
			...
			<!-- start text -->
				...
				<h1>Property Disclosure for the Buyer</h1>
					
					<p>North Carolina General Statute 47E requires a seller to fill out a property disclosure statement when property is sold, and to provide the disclosure statement to all potential purchasers in connection with the sale (unless the purchaser is a tenant already occupying or intending to occupy the dwelling). Individuals selling their own home must also provide the form. Exceptions to this statute include:</p>
					...
					<p>Click on the "Property Disclosure Statement" link to review the information you are entitled to receive and download a copy of the form in "PDF" format if you desire: <a href="http://www.ncrec.state.nc.us/forms/rec422.pdf" target="_blank">Property Disclosure Statement</a></p>
