...
<html>
<head>
	<title>Holly Springs, North Carolina North Carolina Public and Semi-Private Golf Courses: Raleigh - Cary - Apex - Research Triangle Park - Wake County - Triangle, NC Real Estate Agent Chris Edwards</title>
	
	<meta name="Description" content="Holly Springs, North Carolina North Carolina Public and Semi-Private Golf Courses by Chris Edwards with RE/MAX United in Cary, North Carolina.">
	...
	<tr>
		...
		<td id="right">
			...
			<!-- start text -->
				...
				<h1>Holly Springs, North Carolina North Carolina Public and Semi-Private Golf Courses</h1>
				...
				<table id="recruiters">
					<tbody>
						...
						<tr>
							<td class="course">
								<strong>Devils Ridge Golf Club</strong><br />
								5107 Linksland Dr<br />
								Holly Springs, NC 27540<br />
								(919) 557-6101
							</td>
							<td class="other">72</td>
							<td class="designer">John LaFoy</td>
							<td class="other">7,002</td>
							<td class="other">1991</td>
						</tr>
						
						<tr>
							<td class="course">
								<strong>Twelve Oaks Golf Club</strong><br />
								New Hill Rd.<br />
								Holly Springs, NC 27540<br />
								(919) 557-6850
							</td>
							<td class="other">72</td>
							<td class="designer">Jack Nicklaus</td>
							<td class="other">7,219</td>
							<td class="other">2008</td>
						</tr>
