...
<html>
<head>
	<title>Fuquay Varina, North Carolina Public, Semi-Private and Private Golf Courses: Raleigh - Cary - Apex - Research Triangle Park - Wake County - Triangle, NC Real Estate Agent Chris Edwards</title>
	
	<meta name="Description" content="Fuquay Varina, North Carolina Public, Semi-Private and Private Golf Courses by Chris Edwards with RE/MAX United in Cary, North Carolina.">
	...
	<tr>
		...
		<td id="right">
			...
			<!-- start text -->
				...
				<h1>Fuquay Varina, North Carolina Public, Semi-Private and Private Golf Courses</h1>
				...
				<table id="recruiters">
					<tbody>
						...
						<tr>
							<td class="course">
								<strong>Crooked Creek Golf Club</strong><br />
								4621 Shady Greens Dr.<br />
								Fuquay Varina, NC 27526<br />
								(919) 557-7529
							</td>
							<td class="other">71</td>
							<td class="designer">Chuck Smith</td>
							<td class="other">6,271</td>
							<td class="other">1994</td>
						</tr>
						
						<tr>
							<td class="course">
								<strong>Bentwinds Country Club</strong> (Private)<br />
								6536 Dornoch Place<br />
								Fuquay-Varina, NC 27526<br />
								(919) 552-5656
							</td>
							<td class="other">72</td>
							<td class="designer">Tom Hunter</td>
							<td class="other">6,466</td>
							<td class="other">1965</td>
						</tr>
