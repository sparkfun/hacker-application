...
<html>
<head>
	<title>Wyndfall at Regency Neighborhood of Raleigh, North Carolina - Chris Edwards RE/MAX United</title>
	
	<meta name="Description" content="Description of the Wyndfall at Regency neighborhood in Raleigh, North Carolina.">

	<meta name="Keywords" content="Raleigh, Wyndfall at Regency, North Carolina">
	...
	<tr>
		...
		<td id="right">
			...
			<!-- start flash & featured listing -->
				<table border="0">
					<tr>
						...
						<td><img src="/images/left-pix/wyndfall-sign.jpg" alt="" width="290" height="210" border="0"><img src="/images/right-pix/rt-tours.jpg" alt="Contact Chris Edwards for Real Estate in the Triangle Area of Raleigh, Cary and Apex North Carolina" width="290" height="210" border="0"></td>
						<!-- end flash or photo -->
			...
			<!-- start text -->
				...
				<h1>Wyndfall at Regency Neighborhood Profile</h1>
				    ...
				    <td>
						...
						<ul class="whylist">
							...
							<li class="why">
								Price range is $550,000 - 1 Million
							</li>
							<li class="why">
						...
						<p>Wyndfall is at the third level of pricing and homes usually offer the buyer more construction quality and upgrades throughout as well as arge lot sizes, not to mention the location and amenities that the Regency Park Area is famous for!</p> 
