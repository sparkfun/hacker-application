...
<html>
<head>
	<title>Search ALL homes for sale in Raleigh, Cary, Apex, Holly Springs &amp; surrounding areas.</title>
	...
	<tr>
		...
		<td id="right">
			...
			<!-- start text -->
					...
					<h1 class="body">
						Search ALL homes for sale in Raleigh, Cary, Apex, Holly Springs &amp; surrounding areas.
					</h1>
	
					<iframe src="http://prod-connect.us/clients/chrisedwardsgroup/" frameborder="0" style="height:1900px;width:685px;" id="idxconnect" name="idxconnect">Please upgrade your browser</iframe>

					<script type="text/javascript">
					   var param = document.location.search;
					   document.getElementById('idxconnect').src='http://prod-connect.us/clients/chrisedwardsgroup/'+param;
					</script>
