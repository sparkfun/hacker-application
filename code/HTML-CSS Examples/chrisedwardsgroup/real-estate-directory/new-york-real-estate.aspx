...
<html>
<head>
	<title>Real Estate Agents Link Directory - New York</title>
	...
	<tr>
		...
		<td id="right">
			...
			<!-- start text -->
				...
				<h1>Real Estate Agents Link Directory - New York</h1>
					
				<p>Here are some helpful links pertaining to Real Estate and Real Estate agents in New York.</p>
				...
				<ul class="whylist">
					<li class="why">
						<a href="http://www.catskill4sale.com" target="_blank">Sullivan County, NY Real Estate</a> - Catskills Buyer Agency, serving home buyers in the Sullivan County, New York Catskills. Farms, lakefront, mountain real estate.
					</li>
				</ul>
