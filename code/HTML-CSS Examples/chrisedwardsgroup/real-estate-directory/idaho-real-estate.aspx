...
<html>
<head>
	<title>Real Estate Agents Link Directory - Idaho</title>
	...
	<tr>
		...
		<td id="right">
			...
			<!-- start text -->
				...
				<h1>Real Estate Agents Link Directory - Idaho</h1>
					
				<p>Here are some helpful links pertaining to Real Estate and Real Estate agents in Idaho.</p>
				...
				<ul class="whylist">
					<li class="why">
						<a href="http://www.showshown.com/property/" target="_blank">Shoshone Idaho Real Estate, Land, and Investment Property For Sale</a> - Listing of properties for sale by owner in Lincoln County Idaho. Includes the cities of Dietrich, Richfield, and Shoshone. People from Lincoln County who are selling their house, ranch, apartment building, investment property, or other real estate can list it here. 
					</li>
				</ul>
