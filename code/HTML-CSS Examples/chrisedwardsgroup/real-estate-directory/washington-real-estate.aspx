...
<html>
<head>
	<title>Real Estate Agents Link Directory - Washington</title>
	...
	<tr>
		...
		<td id="right">
			...
			<!-- start text -->
				...
				<h1>Real Estate Agents Link Directory - Washington</h1>
					
				<p>Here are some helpful links pertaining to Real Estate and Real Estate agents in Washington.</p>
				...
				<ul class="whylist">
					<li class="why">
						<a href="http://www.seattle-bellevue-real-estate.com/" target="_blank">Seattle-Bellevue-Eastside, Washington Real Estate and Homes</a> - The Robertson &amp; Smith Team, a member of the Windermere family offer your complete source for real estate in Seattle and the Greater Eastside!
					</li>
					<li class="why">
						<a href="http://www.heartofseattlehomes.com/" target="_blank">Seattle Real Estate and Homes</a> - Corey Robinson with John L. Scott Real Estate offering Real Estate in Seattle, Washington. Specializing in the Ballard, Green Lake, Phinney Ridge, Queen Anne and Wallingford neighborhoods of Seattle.
					</li>
				</ul>
