...
<html>
<head>
	<title>Real Estate Information Link Directory - Consumer Information</title>
	...
	<tr>
		...
		<td id="right">
			...
			<!-- start text -->
				...
				<h1>Real Estate Information Link Directory - Consumer Information</h1>
					
				<p>Here are some helpful links pertaining to Real Estate Consumer Information.</p>
				...
				<ul class="whylist">
					<li class="why">
						<a href="http://recenter.tamu.edu/" target="_blank">Real Estate Center - Mays Business School, Texas A&amp;M University</a>
					</li>
					<li class="why">
						<a href="http://www.ourbroker.com" target="_blank">OurBroker&reg; Real Estate Center</a>
					</li>
				</ul>
