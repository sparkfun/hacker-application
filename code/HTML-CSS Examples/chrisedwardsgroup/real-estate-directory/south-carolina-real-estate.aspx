...
<html>
<head>
	<title>Real Estate Agents Link Directory - South Carolina</title>
	...
	<tr>
		...
		<td id="right">
			...
			<!-- start text -->
				...
				<h1>Real Estate Agents Link Directory - South Carolina</h1>
					
				<p>Here are some helpful links pertaining to Real Estate and Real Estate agents in South Carolina.</p>
				
				<h2>
					Real Estate Agents in South Carolina
				</h2>
				
				<ul class="whylist">
					<li class="why">
						<a href="http://www.jaycosta.com/" target="_blank">Jay Costa Realty</a> - Properties in Hilton Head and the surrounding area of South Carolina.
					</li>
					<li class="why">
						<a href="http://www.wesselrealestate.com/" target="_blank">Greenville SC Real Estate</a> - I specialize as a buyer's agent for the Greenville South Carolina area, including Greenville, Greer, Simpsonville, Taylors, Travelers Rest, Easley and downtown Greenville.  The Greenville area is wonderful place to live located at the foothills of the Blue Ridge Parkway! Lakes, views, downtown condos, and quality of life!
					</li>
				</ul>
