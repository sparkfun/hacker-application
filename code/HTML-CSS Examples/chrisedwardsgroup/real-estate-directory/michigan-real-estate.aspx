...
<html>
<head>
	<title>Real Estate Agents Link Directory - Michigan</title>
	...
	<tr>
		...
		<td id="right">
			...
			<!-- start text -->
				...
				<h1>Real Estate Agents Link Directory - Michigan</h1>
					
				<p>Here are some helpful links pertaining to Real Estate and Real Estate agents in Michigan.</p>
				...
				<ul class="whylist">
					<li class="why">
						<a href="http://www.ahomeinmacomb.com/" target="_blank">A Home In Macomb – Paul Edwards – Century 21 Town &amp; Country</a> - Search the MLS for homes listed with professional REALTORS in Macomb County and surrounding cities. If you are considering a move to the southeast Michigan area, this website has all the information you will need!
					</li>
					<li class="why">
						<a href="http://www.grhomebroker.com/" target="_blank">Grand Rapids Real Estate</a> – Search homes for sale in and around Grand Rapids, Michigan.
					</li>
				</ul>
