...
<html>
<head>
	<title>Real Estate Agents Link Directory - Kentucky</title>
	...
	<tr>
		...
		<td id="right">
			...
			<!-- start text -->
				...
				<h1>Real Estate Agents Link Directory - Kentucky</h1>
					
				<p>Here are some helpful links pertaining to Real Estate and Real Estate agents in Kentucky.</p>
				...
				<ul class="whylist">
					<li class="why">
						<a href="http://www.homesinlouisville.com/" target="_blank">Louisville Real Estate</a> - RE/MAX Properties East-Your Louisville KY (Kentucky) real estate experts. Search the MLS for homes and houses. We offer complete Real Estate services for Louisville KY and the surrounding area.
					</li>
				</ul>
