...
<html>
<head>
	<title>Real Estate Agents Link Directory - Virginia</title>
	...
	<tr>
		...
		<td id="right">
			...
			<!-- start text -->
				...
				<h1>Real Estate Agents Link Directory - Virginia</h1>
					
				<p>Here are some helpful links pertaining to Real Estate and Real Estate agents in Virginia.</p>
				...
				<ul class="whylist">
					<li class="why">
						<a href="http://www.lakeannacountry.com/" target="_blank">A warm welcome to Lake Anna and Beyond</a> - If it's about Real Estate ...Ask Kate Elim! Are you looking for home or land property for RETIREMENT, a weekend RETREAT or INVESTMENT? Discover what this wonderful lake and surrounding countryside has to offer.
					</li>
					<li class="why">
						<a href="http://www.lakeannahomes.com/" target="_blank">The Dunn Team, Lake Living Specialists</a> - Your Lake Anna, VA Custom Home Builder and RE/MAX Residential home and land property specialist.
					</li>
				</ul>
