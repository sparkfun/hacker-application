...
<html>
<head>
	<title>Real Estate Agents Link Directory - Massachusetts</title>
	...
	<tr>
		...
		<td id="right">
			...
			<!-- start text -->
				...
				<h1>Real Estate Agents Link Directory - Massachusetts</h1>
					
				<p>Here are some helpful links pertaining to Real Estate and Real Estate agents in Massachusetts.</p>
				...
				<ul class="whylist">
					<li class="why">
						<a href="http://www.HomesInBoston.com/" target="_blank">Boston and Newton Real Estate &amp; Homes For Sale In Boston, MA</a> - One of the largest and most informative Boston real estate websites. You can research the entire buying and selling process as well as search through every property listed for sale in the Greater Boston area MLS!
					</li>
					<li class="why">
						<a href="http://www.bushari.com/" target="_blank">Boston Luxury Real Estate</a> - Greater Boston Real Estate. Complete guide for sellers, buyers, relocation and for sale by owner. Search MA MLS free and with no obligation. All the information you need about luxury developments and investments.
					</li>
				</ul>
