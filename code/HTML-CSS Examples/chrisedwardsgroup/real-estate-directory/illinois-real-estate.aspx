...
<html>
<head>
	<title>Real Estate Agents Link Directory - Illinois</title>
	...
	<tr>
		...
		<td id="right">
			...
			<!-- start text -->
				...
				<h1>Real Estate Agents Link Directory - Illinois</h1>
					
				<p>Here are some helpful links pertaining to Real Estate and Real Estate agents in Illinois.</p>
				...
				<ul class="whylist">
					<li class="why">
						<a href="http://www.real-estate-urbana-champaign-illinois.com/" target="_blank">Champaign Real Estate - Champaign Realtor - Champaign Real Estate Broker</a> - Top real estate solutions for Champaign Urbana Real Estate.  Your #1 Champaign Real 
Estate Team! 
					</li>
				</ul>
