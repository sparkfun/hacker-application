<%@ Page Debug="False" Trace="False" EnableViewState="True" Inherits="ChrisEdwardsGroup.Website.Contact" %>
...
<html>
<head>
	<title>Contact Chris Edwards with RE/MAX United Cary, North Carolina.</title>
	
	<meta name="Description" content="Contact Chris Edwards with RE/MAX United in Cary, North Carolina.">

	<meta name="Keywords" content="Chris Edwards, Chris Edwards Group, RE/MAX United, Cary, North Carolina, RE/MAX North Carolina">
	...
	<tr>
		...
		<td id="right">
			...
			<!-- start text -->
				...
				<h1>Contact Chris Edwards</h1>
					
				<p>Please send me your inquiry and I will get back to you within 24-48 hours.</p>
				...
				<table class="forms">
					<tbody>
						...
						<tr>
							<td class="homesearch" colspan="2">
								<asp:Button id="submitButton" Text="Send Contact Form" CausesValidation="True" OnClick="Submit_OnClick" runat="server" />&nbsp;&nbsp;<input type="reset" value="Cancel">
							</td>
						</tr>
					</tbody>
				</table>
