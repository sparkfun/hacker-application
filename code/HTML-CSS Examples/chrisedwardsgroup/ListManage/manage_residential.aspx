<%@ Page Language="c#" Debug="False" Inherits="ChrisEdwardsGroup.ListManage.ManageResidential" %>
...
<html>
	<head>
		<title>Chris Edwards Group - Listing Management - Manage Property: Residential Property</title>
   ...
   <td colspan="3">
				<table border="0" class="backgroundtitleqnav">
					<tr>
						<td class="pagetitle" colspan="3">Manage Property: Residential Property</td>
					</tr>
					<tr>
						<td class="quicklisting">Quick Info:</td>
						<td class="quicklistinginfo">Created on: <asp:Label id="lblListingDateTime" runat="server" /></td>
						<td class="quicklistinginfo">Last edit: <asp:Label id="lblLastEditDateTime" runat="server" /></td>
					</tr>
				</table>
			</td>
	</tr>
    ...
    <td colspan="3" class="innercontent">
		...
		<asp:DataList id="dlResListing"
							CellPadding="3"
							ExtractTemplateRows="True"
							OnCancelCommand="ResProp_Cancel" 
							OnEditCommand="ResProp_Edit" 
							OnItemCreated="ResProp_ItemCreated"
							OnItemDataBound="ResProp_DataBound" 
							OnUpdateCommand="ResProp_Update"
							OnDeleteCommand="ResProp_Delete"
							runat="server">
   ...
   <ItemTemplate>
   	...
   	<asp:TableRow>
   		<asp:TableCell CssClass="imagehead" ColumnSpan="3"><a href="manage_residential.aspx"><img src="graphics/manage_bar_01.gif" alt="Manage Property" width="145" height="24" border="0"></a><a href="manage_pictures_residential.aspx"><img src="graphics/manage_bar_02.gif" alt="Manage Pictures" width="132" height="24" border="0"></a><a href="manage_tours_residential.aspx"><img src="graphics/manage_bar_03.gif" alt="Manage Tours" width="132" height="24" border="0"></a></asp:TableCell>
  		</asp:TableRow>
   		...
   		<asp:TableCell CssClass="cellhead">MLS#:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcMLS" CssClass="padleftinput" />
					<asp:TableCell id="tcAltMLS" CssClass="padleftinput" />
					<asp:TableCell id="tcPrice" CssClass="padleftinput" />
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="cellhead">Listing Agent #1:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcAgent1" CssClass="padleftinput" />
					<asp:TableCell id="tcAgent2" CssClass="padleftinput" />
					<asp:TableCell CssClass="padleftinput">&nbsp;</asp:TableCell>
  	</asp:TableRow>
			<asp:TableRow>
   	...
   	<asp:TableCell CssClass="cellhead" ColumnSpan="2">Tagline:</asp:TableCell>
			...
			<asp:TableRow>
				<asp:TableCell id="tcOwner" CssClass="padleftinput" />
   	<asp:TableCell id="tcTagline" CssClass="padleftinput" ColumnSpan="2" />
  	</asp:TableRow>
			<asp:TableRow>
   	<asp:TableCell CssClass="sectionhead" ColumnSpan="3">Address</asp:TableCell>
   		...
   		<asp:TableCell CssClass="cellhead">Address #1:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcAddress1" CssClass="padleftinput" />
					<asp:TableCell id="tcAddress2" CssClass="padleftinput" ColumnSpan="2" />
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="cellhead">City:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcCity" CssClass="padleftinput" />
					<asp:TableCell id="tcSubdivision" CssClass="padleftinput" ColumnSpan="2" />
  	</asp:TableRow>
			<asp:TableRow>
   		...
   		<asp:TableCell CssClass="cellhead">Taxes:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcAnnualTaxes" CssClass="padleftinput" />
					<asp:TableCell id="tcAnnualTaxYear" CssClass="padleftinput" />
					<asp:TableCell id="tcScheduleNumber" CssClass="padleftinput" />
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="cellhead" ColumnSpan="3">Assessments:</asp:TableCell>
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell id="tcAssessments" CssClass="padleftinput" ColumnSpan="3" />
  	</asp:TableRow>
			<asp:TableRow>
   		...
   		<asp:TableCell CssClass="cellhead">Bedrooms:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcBedrooms" CssClass="padleftinput" />
					<asp:TableCell id="tcBaths" CssClass="padleftinput" />
					<asp:TableCell id="tcSquareFt" CssClass="padleftinput" />
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="cellhead">Year Built:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcYearBuilt" CssClass="padleftinput" />
					<asp:TableCell id="tcYearRemodeled" CssClass="padleftinput" />
					<asp:TableCell id="tcParcelSize" CssClass="padleftinput" />
  	</asp:TableRow>
			<asp:TableRow>
   	...
   	<asp:TableCell CssClass="cellhead">Foundation:</asp:TableCell>
			...
			<asp:TableRow>
				<asp:TableCell id="tcStyle" CssClass="padleftinput" />
   	<asp:TableCell id="tcFoundation" CssClass="padleftinput" />
				<asp:TableCell id="tcConstruction" CssClass="padleftinput" />
  	</asp:TableRow>
			<asp:TableRow>
   	...
   	<asp:TableCell CssClass="cellhead" ColumnSpan="2">Garage:</asp:TableCell>
			...
			<asp:TableRow>
				<asp:TableCell id="tcRoof" CssClass="padleftinput" />
   	<asp:TableCell id="tcGarage" CssClass="padleftinput" ColumnSpan="2" />
  	</asp:TableRow>
			<asp:TableRow>
			...
			<asp:TableRow>
					<asp:TableCell id="tcPatio" CssClass="padleftinput" />
					<asp:TableCell id="tcDeck" CssClass="padleftinput" ColumnSpan="2" />
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="cellhead">Fenced:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcFenced" CssClass="padleftinput" />
					<asp:TableCell id="tcFencingDescription" CssClass="padleftinput" ColumnSpan="2" />
  	</asp:TableRow>
			<asp:TableRow>
   		...
   		<asp:TableCell CssClass="cellhead">Heating:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcHeating" CssClass="padleftinput" />
					<asp:TableCell id="tcFireplace" CssClass="padleftinput" />
					<asp:TableCell id="tcWoodstove" CssClass="padleftinput" />
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="cellhead">Electricity Provider:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcElectricityProvider" CssClass="padleftinput" />
					<asp:TableCell id="tcElectricityMonthlyCost" CssClass="padleftinput" ColumnSpan="2" />
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="cellhead">Domestic Water Provider:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcDomWaterProvider" CssClass="padleftinput" />
					<asp:TableCell id="tcDomWaterMonthlyCost" CssClass="padleftinput" ColumnSpan="2" />
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="cellhead">Irrigation Water Provider:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcIrrWaterProvider" CssClass="padleftinput" />
					<asp:TableCell id="tcIrrWaterShares" CssClass="padleftinput" />
					<asp:TableCell id="tcIrrWaterMonthlyCost" CssClass="padleftinput" />
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="cellhead" ColumnSpan="3">Sewer:</asp:TableCell>
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell id="tcSewer" CssClass="padleftinput" ColumnSpan="3" />
  	</asp:TableRow>
			<asp:TableRow>
   		...
   		<asp:TableCell CssClass="cellhead">Kitchen:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcKitchenDim" CssClass="padleftinput" />
					<asp:TableCell id="tcLivingRoomDim" CssClass="padleftinput" />
					<asp:TableCell id="tcDiningRoomDim" CssClass="padleftinput" />
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="cellhead" ColumnSpan="3">Family Room:</asp:TableCell>
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell id="tcFamilyRoomDim" CssClass="padleftinput" ColumnSpan="3" />
  	</asp:TableRow>
			<asp:TableRow>
   		...
   		<asp:TableCell CssClass="cellhead">Master Bedroom:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcMasterBedDim" CssClass="padleftinput" />
					<asp:TableCell id="tcBedroom2Dim" CssClass="padleftinput" />
					<asp:TableCell id="tcBedroom3Dim" CssClass="padleftinput" />
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="cellhead" ColumnSpan="3">Bedroom #4:</asp:TableCell>
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell id="tcBedroom4Dim" CssClass="padleftinput" ColumnSpan="3" />
  	</asp:TableRow>
			<asp:TableRow>
   		...
   		<asp:TableCell CssClass="cellhead">Bathroom #1:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcBathroom1Dim" CssClass="padleftinput" />
					<asp:TableCell id="tcBathroom2Dim" CssClass="padleftinput" />
					<asp:TableCell id="tcBathroom3Dim" CssClass="padleftinput" />
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="cellhead" ColumnSpan="3">Bathroom #4:</asp:TableCell>
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell id="tcBathroom4Dim" CssClass="padleftinput" ColumnSpan="3" />
  	</asp:TableRow>
			<asp:TableRow>
   		...
   		<asp:TableCell CssClass="cellhead">Basement Dimensions:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcBasementDim" CssClass="padleftinput" />
					<asp:TableCell id="tcGarageDim" CssClass="padleftinput" />
					<asp:TableCell id="tcPatioDim" CssClass="padleftinput" />
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="cellhead">Deck Dimensions:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcDeckDim" CssClass="padleftinput" />
					<asp:TableCell id="tcShedDim" CssClass="padleftinput" />
					<asp:TableCell id="tcOfficeDim" CssClass="padleftinput" />
  	</asp:TableRow>
			<asp:TableRow>
			...
			<asp:TableRow>
				<asp:TableCell id="tcMediaRoomDim" CssClass="padleftinput" />
				<asp:TableCell id="tcLaundryRoomDim" CssClass="padleftinput" />
				<asp:TableCell id="tcSunroomDim" CssClass="padleftinput" />
  	</asp:TableRow>
			<asp:TableRow>
   		...
   		<asp:TableCell CssClass="cellhead" ColumnSpan="2">Possession:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcPossession" CssClass="padleftinput" ColumnSpan="2" />
					<asp:TableCell id="tcEarnestMoney" CssClass="padleftinput" />
  	</asp:TableRow>
			<asp:TableRow>
   		...
   		<asp:TableCell CssClass="cellhead" ColumnSpan="3">Features Description:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcFeaturesDescription" CssClass="padleftinput" ColumnSpan="3" />
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="cellhead" ColumnSpan="3">Inclusions Description:</asp:TableCell>
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell id="tcInclusionsDescription" CssClass="padleftinput" ColumnSpan="3" />
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="cellhead" ColumnSpan="3">Exclusions Description:</asp:TableCell>
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell id="tcExclusionsDescription" CssClass="padleftinput" ColumnSpan="3" />
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="cellhead" ColumnSpan="3">Outbuildings Description:</asp:TableCell>
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell id="tcOutbuildingsDescription" CssClass="padleftinput" ColumnSpan="3" />
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="cellhead" ColumnSpan="3">Disclosures Description:</asp:TableCell>
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell id="tcDisclosuresDescription" CssClass="padleftinput" ColumnSpan="3" />
  	</asp:TableRow>
			<asp:TableRow>
   		...
   		<asp:TableCell CssClass="cellhead" ColumnSpan="3">Map Directions to Property:</asp:TableCell>
			...
			<asp:TableRow>
   		<asp:TableCell id="tcMapDirections" CssClass="padleftinput" ColumnSpan="3" />
  	</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="buttonmanageoptions" ColumnSpan="3">Management Options:</asp:TableCell>
			</asp:TableRow>
			<asp:TableRow>
   		<asp:TableCell CssClass="buttonstrip" ColumnSpan="3">
						<asp:Button id="btnEditButton" Text="Edit" CommandName="edit" CssClass="buttons" CausesValidation="False" runat="server" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<asp:Button id="btnDeleteButton" Text="Delete" CommandName="delete" CssClass="buttons" CausesValidation="True" runat="server" />
						<asp:CustomValidator id="cvConfirmDelete"
           ClientValidationFunction="confirmDelete"
           Display="None"
           runat="server" />
					</asp:TableCell>
			</asp:TableRow>
	...
	<EditItemTemplate>
		...
		<asp:Table id="tblResListing" runat="server">
			...
			<asp:TableRow>
   	<asp:TableCell CssClass="imagehead" ColumnSpan="3">
   	...
   	<asp:TableCell CssClass="imagehead" ColumnSpan="3"><a href="manage_residential.aspx"><img src="graphics/manage_bar_01.gif" alt="Manage Property" width="145" height="24" border="0"></a><a href="manage_pictures_residential.aspx"><img src="graphics/manage_bar_02.gif" alt="Manage Pictures" width="132" height="24" border="0"></a><a href="manage_tours_residential.aspx"><img src="graphics/manage_bar_03.gif" alt="Manage Tours" width="132" height="24" border="0"></a></asp:TableCell>
   		...
   		<asp:TableCell CssClass="buttonmanageoptions" ColumnSpan="3">Management Options:</asp:TableCell>
			...
			<asp:TableRow>
				<asp:TableCell CssClass="buttonstrip" ColumnSpan="3">
					<asp:Button id="UpdateButton" Text="Update" CommandName="update" CssClass="buttons" runat="server" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<asp:Button id="CancelButton" Text="Cancel" CommandName="cancel" CssClass="buttons" runat="server" />
			</asp:TableCell>
		</asp:TableRow>
