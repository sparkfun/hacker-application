...
<html>
<head>
	<title>Employment in North Carolina</title>
	
	<meta name="Description" content="Employment links for Raleigh, Cary and Wake County, North Carolina.">

	<meta name="Keywords" content="Raleigh, Cary, Wake County, Employment Links">
	...
	<tr>
		...
		<td id="right">
			...
			<!-- start text -->
				...
				<h1>Employment in North Carolina</h1>
					
				<p>Here are some helpful links pertaining to employment in Raleigh, Cary and Apex, North Carolina.</p>
				
				<ul class="whylist">
					<li class="why">
						<a href="http://raleigh.employmentguide.com/" target="_blank">Raleigh Employment Guide</a>
					</li>
				</ul>
