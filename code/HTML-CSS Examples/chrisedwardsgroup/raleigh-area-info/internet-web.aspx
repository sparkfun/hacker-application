...
<html>
<head>
	<title>Internet and Web in North Carolina</title>
	
	<meta name="Description" content="Internet and web links for Raleigh, Cary and Wake County, North Carolina.">

	<meta name="Keywords" content="Raleigh, Cary, Wake County, Internet, Web">
	...
	<tr>
		...
		<td id="right">
			...
			<!-- start text -->
				...
				<h1>Internet and Web in North Carolina</h1>
					
				<p>Here are some helpful links pertaining to the Internet and the web in North Carolina.</p>
				
				<ul class="whylist">
					<li class="why">
						<a href="http://www.mobile1ringtones.com/" target="_blank">Mobile-1-Ringtones</a> - Phone Games Mobile Wallpaper and Ringers
					</li>
				</ul>
