		...
		<div id="body">
			...
			<div id="left">
				...
				<div id="leftSection">
					...
					<p>Stop 'n Save is very selective about hiring.  Stop 'n Save is the best only because the people who work here are the best. Every step is taken to make sure there is a good fit between Stop 'n Save and the potential new employee.</p>

					<h3>Step 1</h3>
					
					<p class="reportDownload"><a href="EmploymentApplication.pdf" target="_blank">Download the application</a>.  Print the application out and fill it in and bring it in to one of our stores.</p>
