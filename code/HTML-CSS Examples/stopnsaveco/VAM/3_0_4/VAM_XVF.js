...
function VAM_IMCChildren(pFld, pGrp, pAll, pLoc){var vC = pFld.childNodes != null ? pFld.childNodes : pFld.children;if (vC != null)for (var vI = 0; vI < vC.length; vI++){if (vC[vI] != null){VAM_IMCUpdate(vC[vI], pGrp, pAll, pLoc);VAM_IMCChildren(vC[vI], pGrp, pAll, pLoc); }}}
...
function VAM_InitLinkMenuControl(pFldID, pGrp, pMsg){var vFld = VAM_GetById(pFldID);if (vFld != null){VAM_ILMChildren(vFld, pGrp, pMsg);}}
function VAM_ILMChildren(pFld, pGrp, pMsg){var vC = pFld.childNodes != null ? pFld.childNodes : pFld.children;if (vC != null)for (var vI = 0; vI < vC.length; vI++){if (vC[vI] != null){if (vC[vI].tagName == "A"){VAM_InitLinkBtn(vC[vI], pGrp, pMsg);continue; }VAM_ILMChildren(vC[vI], pGrp, pMsg); }}} 