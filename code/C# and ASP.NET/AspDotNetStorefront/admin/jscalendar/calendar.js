 ...
 * 
 * This license agreement explicitely allows the licensee use of the JS
...
Calendar.cellClick = function(el, ev) {
	...
	if (typeof el.navtype == "undefined") {
		...
		switch (el.navtype) {
			...
			var _ml = RegExp.multiline;
			RegExp.multiline = true;
			text = text.replace(/^.*LGPL.*$/i, "Licensed to Discovery Productions, Inc.");
			RegExp.multiline = _ml;
...
Calendar.prototype.showAtElement = function (el, opts) {
	...
	this.element.style.display = "block";
	Calendar.continuation_for_browser = function() {
	...
	if (Calendar.is_khtml)
		setTimeout("Calendar.continuation_for_browser()", 10);
	else
		Calendar.continuation_for_browser();
};
