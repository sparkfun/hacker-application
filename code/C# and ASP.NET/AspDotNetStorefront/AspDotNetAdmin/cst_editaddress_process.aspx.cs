...
namespace AspDotNetStorefront
{
	...
	/// </summary>
	public class cst_editaddress_process : System.Web.UI.Page
	{
      ...
      int DeleteAddressID = Common.FormUSInt("DeleteAddressID");
      ...
      if (DeleteAddressID != 0) 
        ...
        Response.Redirect("cst_selectaddress.aspx?" +Common.ServerVariables("QUERY_STRING"));
      }
