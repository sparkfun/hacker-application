...
namespace AspDotNetStorefrontGateways
{
	...
	public class AuthorizeNet
	{
		...
		static public String CaptureOrder(int OrderNumber)
		{
			...
			String X_Login = Common.AppConfig("AUTHORIZENET_X_LOGIN");
			...
			String X_TranKey = Common.AppConfig("AUTHORIZENET_X_TRAN_KEY");
			...
			transactionCommand.Append("&x_version=" + Common.AppConfig("AUTHORIZENET_X_VERSION"));
			transactionCommand.Append("&x_test_request=" + Common.IIF(useLiveTransactions , "FALSE" , "TRUE"));
			transactionCommand.Append("&x_method=" + Common.AppConfig("AUTHORIZENET_X_METHOD"));
			transactionCommand.Append("&x_delim_data=" + Common.AppConfig("AUTHORIZENET_X_DELIM_DATA"));
			transactionCommand.Append("&x_delim_char=" + Common.AppConfig("AUTHORIZENET_X_DELIM_CHAR"));
			transactionCommand.Append("&x_encap_char=" + Common.AppConfig("AUTHORIZENET_X_ENCAP_CHAR"));
			transactionCommand.Append("&x_relay_response=" + Common.AppConfig("AUTHORIZENET_X_RELAY_RESPONSE"));
			...
			try
			{
				...
				// Prepare web request...
				String AuthServer = Common.IIF(useLiveTransactions , Common.AppConfig("AUTHORIZENET_LIVE_SERVER") , Common.AppConfig("AUTHORIZENET_TEST_SERVER"));
				...
				String[] statusArray = rawResponseString.Split(Common.AppConfig("AUTHORIZENET_X_DELIM_CHAR").ToCharArray());
		...
		static public String ProcessCard(int OrderNumber, ShoppingCart cart, String CardName, String CardType, String CardNumber, String CardExtraCode, String CardExpirationMonth, String CardExpirationYear, Decimal OrderTotal, bool useLiveTransactions, Address Billing, Address Shipping, String CAVV, String ECI, String XID, out bool PaymentCleared, out String AVSResult, out String AuthorizationResult, out String AuthorizationCode, out String AuthorizationTransID, out String TransactionCommandOut)
		{
			...
			transactionCommand.Append("x_type=" + Common.IIF(Common.TransactionMode() == "AUTH" , "AUTH_ONLY" , "AUTH_CAPTURE")); //Common.AppConfig("AUTHORIZENET_X_TYPE"));

			transactionCommand.Append("&x_login=" + X_Login);
			transactionCommand.Append("&x_tran_key=" + X_TranKey);
			transactionCommand.Append("&x_version=" + Common.AppConfig("AUTHORIZENET_X_VERSION"));
			transactionCommand.Append("&x_test_request=" + Common.IIF(useLiveTransactions , "FALSE" , "TRUE"));
			transactionCommand.Append("&x_merchant_email=" + Common.AppConfig("AUTHORIZENET_X_EMAIL"));
			...
			transactionCommand.Append("&x_email_customer=" + Common.AppConfig("AUTHORIZENET_X_EMAIL_CUSTOMER"));
			transactionCommand.Append("&x_recurring_billing=" + Common.AppConfig("AUTHORIZENET_X_RECURRING_BILLING"));
		...
		static public String ProcessECheck(int OrderNumber, ShoppingCart cart, String eCheckBankABACode,String eCheckBankAccountNumber,String eCheckBankAccountType,String eCheckBankName,String eCheckBankAccountName, Decimal OrderTotal, Address Billing, Address Shipping, out bool PaymentCleared, out String AVSResult, out String AuthorizationResult, out String AuthorizationCode, out String AuthorizationTransID, out String TransactionCommandOut)
		{
			...
			transactionCommand.Append("&x_login=" + Common.AppConfig("AUTHORIZENET_X_LOGIN"));
			transactionCommand.Append("&x_tran_key=" + Common.AppConfig("AUTHORIZENET_X_TRAN_KEY"));
			transactionCommand.Append("&x_version=" + Common.AppConfig("AUTHORIZENET_X_VERSION"));
