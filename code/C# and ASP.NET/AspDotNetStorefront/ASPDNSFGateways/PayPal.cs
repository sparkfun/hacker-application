...
namespace AspDotNetStorefrontGateways
{
	...
	public class PayPal
	{
		...
		{
			String result = "CAPTURE METHOD NOT SUPPORTED FOR PAYPAL";
			return result;
		}

		static public String VoidOrder(int OrderNumber)
		{
			String result = "VOID METHOD NOT SUPPORTED FOR PAYPAL";
			return result;
		}

		static public String RefundOrder(int OrderNumber)
		{
			String result = "REFUND METHOD NOT SUPPORTED FOR PAYPAL";
			return result;
		}
