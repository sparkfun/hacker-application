...
namespace AspDotNetStorefront
{
	...
	public class TOC : System.Web.UI.Page
	{
		...
		{
			_siteID = Common.CookieUSInt("SkinID");
			if (!IsPostBack)
			{
		...
		void RenderTree()
		{
			...
			HomeNode.ImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/home.gif";
			...
			if(Common.IsAdminSite)
			{
				...
				OrdersNode.ImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderclosed.gif";
				OrdersNode.ExpandedImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderopen.gif";
				OrdersNode.SelectedImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderopen.gif";
			...
			CategoryNode.ImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderclosed.gif";
			CategoryNode.ExpandedImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderopen.gif";
			CategoryNode.SelectedImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderopen.gif";
			TreeView1.Nodes.Add(CategoryNode);
			LoadCategoryTree(CategoryNode.Nodes,0,_siteID);
			...
			SectionNode.ImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderclosed.gif";
			SectionNode.ExpandedImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderopen.gif";
			SectionNode.SelectedImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderopen.gif";
			TreeView1.Nodes.Add(SectionNode);
			LoadSectionTree(SectionNode.Nodes,0,_siteID);
			...
			if(Common.AppConfigBool("ShowManufacturerTree") || Common.IsAdminSite)
			{
				...
				ManufacturerNode.ImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderclosed.gif";
				ManufacturerNode.ExpandedImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderopen.gif";
				ManufacturerNode.SelectedImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderopen.gif";
				TreeView1.Nodes.Add(ManufacturerNode);
				LoadManufacturerTree(ManufacturerNode.Nodes,_siteID);
			}
			...
			if(!Common.IsAdminSite)
			{
				...
				if(CustomerServiceTreeMenu.Length != 0)
				{
					...
					CustomerServiceNode.ImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderclosed.gif";
					CustomerServiceNode.ExpandedImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderopen.gif";
					CustomerServiceNode.SelectedImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderopen.gif";
					//RootNode.Expanded = true;
					TreeView1.Nodes.Add(CustomerServiceNode);
					LoadCustomerServiceTree(CustomerServiceNode.Nodes,CustomerServiceTreeMenu,_siteID);
				}
			}
		...
		static private void LoadCategoryTree(TreeNodeCollection Nodes, int ForParentCategoryID, int _siteID)
		{
			if(Common.IsAdminSite)
			{
				...
				while(rs.Read())
				{
					...
					Node.Target = "content";
					Node.ImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderclosed.gif";
					Node.ExpandedImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderopen.gif";
					Node.SelectedImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderopen.gif";
					Nodes.Add(Node);
					if(Common.CategoryHasSubs(DB.RSFieldInt(rs,"CategoryID")))
					{
						LoadCategoryTree(Node.Nodes,DB.RSFieldInt(rs,"CategoryID"),_siteID);
					}
				}
				rs.Close();
			}
		...
		static private void LoadSectionTree(TreeNodeCollection Nodes, int ForParentSectionID, int _siteID)
		{
			if(Common.IsAdminSite)
			{
				String sql = String.Empty;
				...
				while(rs.Read())
				{
					...
					{
						LoadSectionTree(Node.Nodes,DB.RSFieldInt(rs,"SectionID"),_siteID);
					}
				}
				rs.Close();
			}
		...
		static private void LoadManufacturerTree(TreeNodeCollection Nodes, int _siteID)
		{
			if(Common.IsAdminSite)
			{
		...
		static private void LoadCustomerServiceTree(TreeNodeCollection Nodes, String ServiceMenuOptions, int _siteID)
		{
				...
				try
				{
					foreach(String s in ServiceMenuOptions.Split('^'))
					{
						...
						//{
							...
							NewNode.ImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderclosed.gif";
							NewNode.ExpandedImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderopen.gif";
							NewNode.SelectedImageUrl = "skins/skin_" + _siteID.ToString() + "/images/icons/folderopen.gif";
							Nodes.Add(NewNode);
						//}
					}
