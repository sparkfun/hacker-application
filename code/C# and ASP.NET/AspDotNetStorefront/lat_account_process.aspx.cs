...
namespace AspDotNetStorefront
{
	...
	public class lat_account_process : SkinBase
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			SectionTitle = "<a href=\"lat_account.aspx\">" + Common.AppConfig("AffiliateProgramName") + "</a> - Update Account Info";
		}
			...
			if(ErrorMsg.Length == 0)
			{
				...
				try
				{
					...
					if(!Editing)
					{
						...
						sql.Append("insert into Affiliate(AffiliateGUID,EMail,[Password],DateOfBirth,Gender,IsOnline,FirstName,LastName,Name,Company,Address1,Address2,Suite,City,State,Zip,Country,Phone,WebSiteName,WebSiteDescription,URL,TaxRegistrationName,TaxIDNumber,TaxClassification) values(");
...
//			writer.Write("        </table>\n");
			...
			{
				Response.Redirect("lat_account.aspx?updated=true");
			}
