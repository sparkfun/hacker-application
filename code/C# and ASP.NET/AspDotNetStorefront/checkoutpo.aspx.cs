...
{
	/// <summary>
	/// Summary description for checkoutpo.
	/// </summary>
	public class checkoutpo : SkinBase
	{
		private void Page_Load(object sender, System.EventArgs e)
		{
			base.DoOnLoad(); // Allows SkinBase to initialize some vars (e.g. thisCustomer)
			SectionTitle = "Order - Purchase Order:";
			RequireSecurePage();
		...
		{
			Topic t = new Topic("CheckoutPOPageHeader",thisCustomer._localeSetting,_siteID);
			...
			writer.Write("function CheckOutPOForm_Validator(theForm)\n");
			writer.Write("	{\n");
			...
			writer.Write("<form method=\"POST\" action=\"checkoutpo_process.aspx\" name=\"CheckOutPOForm\" id=\"CheckOutPOForm\" onsubmit=\"return (validateForm(this) && CheckOutPOForm_Validator(this))\" onReset=\"return confirm('Do you want to reset all fields to their starting values?');\">");
			...
			writer.Write("<img src=\"skins/Skin_" + _siteID.ToString() + "/images/poinfo.gif\" border=\"0\"><br>");
			...
			writer.Write("      <tr>");
			writer.Write("        <td width=\"100%\"><b>Please Enter Your Purchase Order Information Below:</b></td>");
			writer.Write("      </tr>");
			...
			writer.Write("    <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">");
			writer.Write("      <tr>");
			writer.Write("        <td width=\"25%\">*PO Number:</td>\n");
			writer.Write("        <td width=\"75%\">\n");
			writer.Write("        <input type=\"text\" name=\"PONumber\" size=\"20\" maxlength=\"50\"> (required)\n");
			writer.Write("        <input type=\"hidden\" name=\"PONumber_vldt\" value=\"[req][blankalert=Please enter the purchase order number you will be using]\">\n");
			writer.Write("        </td>");
			writer.Write("      </tr>");
