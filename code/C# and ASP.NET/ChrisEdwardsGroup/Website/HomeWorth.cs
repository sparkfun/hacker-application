...
{
	/// <summary>
	/// Summary description for HomeWorth.
	/// </summary>
	public class HomeWorth : Main
	{
		...
		public void SendMail_HomeWorth()
		{
			...
			// Specify the subject
			emailMessage.Subject = "How Much Is My Raleigh-Cary Home Worth?";
			...
			bodyText += "<head>" + "\r";
			bodyText += "<title>" + "\r";
			bodyText += "How Much Is My Raleigh-Cary Home Worth?" + "\r";
			bodyText += "</title>" + "\r";
			...
			try
			{
				...
				Response.Redirect("raleigh-cary-home-worth-thanks.aspx", true);
			}
