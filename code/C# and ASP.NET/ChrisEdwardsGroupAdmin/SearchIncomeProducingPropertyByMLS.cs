...
{
	/// <summary>
	/// Summary description for SearchIncomeProducingPropertyByMLS.
	/// </summary>
	public class SearchIncomeProducingPropertyByMLS : Main
	{
		...
		public SearchIncomeProducingPropertyByMLS()
		{
			//
		...
		public void SearchByMLS_Click(Object sender, EventArgs e)
		{
			...
			SqlCommand objCommand = new SqlCommand("sp_select_income_producing_prop_search_by_mls", objConnection);
			...
			DataView dv = new DataView(ds.Tables["IncomeProducingProp"]);
