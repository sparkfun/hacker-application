...
{
	/// <summary>
	/// Summary description for BrowseBusinessNoRealEstate.
	/// </summary>
	public class BrowseBusinessNoRealEstate : Main
	{
		public Label lblRecordCount;
		public Label lblOutError;
		public DataGrid dtgBrowse;

		public BrowseBusinessNoRealEstate()
		{
			//
		...
		private void Bind()
		{
			...
			objCommand.CommandText = "sp_select_business_no_re_browse";
			...
			try
			{
				sda.Fill(ds, "BusinessNoRealEstate");
			}
			...
			lblRecordCount.Text = "Found " + 
				ds.Tables["BusinessNoRealEstate"].Rows.Count.ToString() + " records.";

			// Set DataGrid DataSource
			// DataBind() DataGrid
			dtgBrowse.DataSource = ds.Tables["BusinessNoRealEstate"].DefaultView;
			dtgBrowse.DataBind();
		}

		public void BrowseBusinessNoRealEstate_ItemCreated(Object sender, DataGridItemEventArgs e)
		{
