			...
			else
			{
				if (contentType == "image/pjpeg")
				{
					...
					try
					{
						...
						saImgGen.ResizeImage(186, 141, SAIMAGEGENLib.SAImageResizeAlgorithm.saiFilterImage, 0);
						saImgGen.SaveImage(SAIMAGEGENLib.SAImageSaveMethod.saiFile, SAIMAGEGENLib.SAImageFormat.saiJPG, savedFileThumb);

						saImgGen.LoadImage(savedFile);
						saImgGen.ImageQuality = 80;
						saImgGen.ResizeFilter = 8;
						saImgGen.ResizeImage(360, 270, SAIMAGEGENLib.SAImageResizeAlgorithm.saiFilterImage, 0);
						saImgGen.SaveImage(SAIMAGEGENLib.SAImageSaveMethod.saiFile, SAIMAGEGENLib.SAImageFormat.saiJPG, savedFile);
