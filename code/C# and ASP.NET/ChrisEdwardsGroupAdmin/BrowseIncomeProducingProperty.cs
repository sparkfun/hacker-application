...
{
	/// <summary>
	/// Summary description for BrowseIncomeProducingProperty.
	/// </summary>
	public class BrowseIncomeProducingProperty : Main
	{
		public Label lblRecordCount;
		public Label lblOutError;
		public DataGrid dtgBrowse;

		public BrowseIncomeProducingProperty()
		{
			//
		...
		private void Bind()
		{
			...
			objCommand.CommandText = "sp_select_income_producing_prop_browse";
			...
			lblRecordCount.Text = "Found " + 
				ds.Tables["IncomeProducingProp"].Rows.Count.ToString() + " records.";

			// Set DataGrid DataSource
			// DataBind() DataGrid
			dtgBrowse.DataSource = ds.Tables["IncomeProducingProp"].DefaultView;
			dtgBrowse.DataBind();
		}

		public void BrowseIncomeProducingProp_ItemCreated(Object sender, DataGridItemEventArgs e)
		{
