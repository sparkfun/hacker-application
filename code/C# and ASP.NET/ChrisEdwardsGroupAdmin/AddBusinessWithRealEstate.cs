...
{
	public class AddBusinessWithRealEstate : Main
	{
		...
		public void AddBusinessWithRealEstate_Click(Object Source, EventArgs E)
		{
			// Create Connection String
			string strConnect = System.Configuration.ConfigurationSettings.AppSettings["dbConnectString"];
			...
			// Create SqlCommand Object
			SqlCommand objCommand = new SqlCommand("sp_insert_business_with_re", objConnection);
			objCommand.CommandType = CommandType.StoredProcedure;
			...
			Response.Redirect("manage_business_with_re.aspx");
		}
	}
