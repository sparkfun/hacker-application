...
{
	/// <summary>
	/// Summary description for BrowseCommercialRealEstate.
	/// </summary>
	public class BrowseCommercialRealEstate : Main
	{
		public Label lblRecordCount;
		public Label lblOutError;
		public DataGrid dtgBrowse;

		public BrowseCommercialRealEstate()
		{
			//
		...
		private void Bind()
		{
			...
			objCommand.CommandText = "sp_select_commercial_re_browse";
			...
			try
			{
				sda.Fill(ds, "CommercialRealEstate");
			}
			...
			lblRecordCount.Text = "Found " + 
				ds.Tables["CommercialRealEstate"].Rows.Count.ToString() + " records.";

			// Set DataGrid DataSource
			// DataBind() DataGrid
			dtgBrowse.DataSource = ds.Tables["CommercialRealEstate"].DefaultView;
			dtgBrowse.DataBind();
		}

		public void BrowseCommercialRealEstate_ItemCreated(Object sender, DataGridItemEventArgs e)
		{
