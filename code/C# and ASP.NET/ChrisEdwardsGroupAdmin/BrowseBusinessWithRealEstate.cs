...
{
	/// <summary>
	/// Summary description for BrowseBusinessWithRealEstate.
	/// </summary>
	public class BrowseBusinessWithRealEstate : Main
	{
		public Label lblRecordCount;
		public Label lblOutError;
		public DataGrid dtgBrowse;

		public BrowseBusinessWithRealEstate()
		{
			//
		...
		private void Bind()
		{
			...
			objCommand.CommandText = "sp_select_business_with_re_browse";
			...
			try
			{
				sda.Fill(ds, "BusinessWithRealEstate");
			}
			...
			lblRecordCount.Text = "Found " + 
				ds.Tables["BusinessWithRealEstate"].Rows.Count.ToString() + " records.";

			// Set DataGrid DataSource
			// DataBind() DataGrid
			dtgBrowse.DataSource = ds.Tables["BusinessWithRealEstate"].DefaultView;
			dtgBrowse.DataBind();
		}

		public void BrowseBusinessWithRealEstate_ItemCreated(Object sender, DataGridItemEventArgs e)
		{
