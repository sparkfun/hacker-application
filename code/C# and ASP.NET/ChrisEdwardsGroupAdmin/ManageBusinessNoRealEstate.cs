...
namespace ChrisEdwardsGroupAdmin
{
	public class ManageBusinessNoRealEstate : Main
	{
		...
		private void Bind()
		{
			...
			objCommand.CommandText = "sp_select_business_no_re";
			...
			dlBusinessNoRE.DataSource = ds.Tables["BusinessWithRE"].DefaultView;
			dlBusinessNoRE.DataBind();
		}

		public void BusinessNoRE_ItemCreated(Object sender, DataListItemEventArgs e)
		{
		...
		public void BusinessNoRE_Edit(Object sender, DataListCommandEventArgs e)
		{
			dlBusinessNoRE.EditItemIndex = e.Item.ItemIndex;
			hgcErrors.Visible = false;
			Bind();
		}

		public void BusinessNoRE_Cancel(Object sender, DataListCommandEventArgs e)
		{
			dlBusinessNoRE.EditItemIndex = -1;
			hgcErrors.Visible = false;
			Bind();
		}

		public void BusinessNoRE_Delete(Object sender, DataListCommandEventArgs e)
		{
			...
			// Create SqlCommand Object
			SqlCommand objCommand = new SqlCommand("sp_delete_business_no_re", objConnection);
			objCommand.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				Response.Redirect("browse_business_no_re.aspx", true);
			}
		...
		public void BusinessNoRE_Update(Object sender, DataListCommandEventArgs e)
		{
			// Create Connection String
			string strConnect = System.Configuration.ConfigurationSettings.AppSettings["dbConnectString"];
			...
			// Create SqlCommand Object
			SqlCommand objCommand = new SqlCommand("sp_update_business_no_re", objConnection);
			objCommand.CommandType = CommandType.StoredProcedure;
		...
		public void BusinessNoRE_DataBound(Object sender, DataListItemEventArgs e) 
		{
			ListItemType lit = e.Item.ItemType;
