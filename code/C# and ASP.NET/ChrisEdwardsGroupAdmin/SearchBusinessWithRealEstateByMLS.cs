...
{
	/// <summary>
	/// Summary description for SearchBusinessWithRealEstateByMLS.
	/// </summary>
	public class SearchBusinessWithRealEstateByMLS : Main
	{
		...
		public SearchBusinessWithRealEstateByMLS()
		{
			//
		...
		public void SearchByMLS_Click(Object sender, EventArgs e)
		{
			...
			SqlCommand objCommand = new SqlCommand("sp_select_business_with_re_search_by_mls", objConnection);
			...
			DataView dv = new DataView(ds.Tables["BusinessWithRE"]);
