...
{
	/// <summary>
	/// Summary description for SearchBusinessNoRealEstateByMLS.
	/// </summary>
	public class SearchBusinessNoRealEstateByMLS : Main
	{
		...
		public SearchBusinessNoRealEstateByMLS()
		{
			//
		...
		public void SearchByMLS_Click(Object sender, EventArgs e)
		{
			...
			SqlCommand objCommand = new SqlCommand("sp_select_business_no_re_search_by_mls", objConnection);
			...
			DataView dv = new DataView(ds.Tables["BusinessNoRE"]);
