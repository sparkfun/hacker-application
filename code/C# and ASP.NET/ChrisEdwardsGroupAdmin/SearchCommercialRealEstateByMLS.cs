...
{
	/// <summary>
	/// Summary description for SearchCommercialRealEstateByMLS.
	/// </summary>
	public class SearchCommercialRealEstateByMLS : Main
	{
		...
		public SearchCommercialRealEstateByMLS()
		{
			//
		...
		public void SearchByMLS_Click(Object sender, EventArgs e)
		{
			...
			SqlCommand objCommand = new SqlCommand("sp_select_commercial_re_search_by_mls", objConnection);
			...
			DataView dv = new DataView(ds.Tables["CommercialRE"]);
