...
{
	/// <summary>
	/// Summary description for SearchVacantLandByMLS.
	/// </summary>
	public class SearchVacantLandByMLS : Main
	{
		...
		public void SearchByMLS_Click(Object sender, EventArgs e)
		{
			...
			SqlCommand objCommand = new SqlCommand("sp_select_vacant_land_search_by_mls", objConnection);
			...
			DataView dv = new DataView(ds.Tables["VacantLand"]);
