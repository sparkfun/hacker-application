...
{
	/// <summary>
	/// Summary description for BrowseFarmRanch.
	/// </summary>
	public class BrowseFarmRanch : Main
	{
		public Label lblRecordCount;
		public Label lblOutError;
		public DataGrid dtgBrowse;

		public BrowseFarmRanch()
		{
			//
		...
		private void Bind()
		{
			...
			objCommand.CommandText = "sp_select_farmranch_browse";
			...
			lblRecordCount.Text = "Found " + 
				ds.Tables["FarmRanch"].Rows.Count.ToString() + " records.";

			// Set DataGrid DataSource
			// DataBind() DataGrid
			dtgBrowse.DataSource = ds.Tables["FarmRanch"].DefaultView;
			dtgBrowse.DataBind();
		}

		public void BrowseFarmRanch_ItemCreated(Object sender, DataGridItemEventArgs e)
		{
