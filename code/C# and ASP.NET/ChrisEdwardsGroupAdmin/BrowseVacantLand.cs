...
{
	/// <summary>
	/// Summary description for BrowseVacantLand.
	/// </summary>
	public class BrowseVacantLand : Main
	{
		public Label lblRecordCount;
		public Label lblOutError;
		public DataGrid dtgBrowse;

		public BrowseVacantLand()
		{
			//
		...
		private void Bind()
		{
			...
			objCommand.CommandText = "sp_select_vacantland_browse";
			...
			lblRecordCount.Text = "Found " + 
				ds.Tables["VacantLand"].Rows.Count.ToString() + " records.";

			// Set DataGrid DataSource
			// DataBind() DataGrid
			dtgBrowse.DataSource = ds.Tables["VacantLand"].DefaultView;
			dtgBrowse.DataBind();
		}

		public void BrowseVacantLand_ItemCreated(Object sender, DataGridItemEventArgs e)
		{
